...
function ListGroup({ token, fetchLists, lists }) {
        ...
        <div className='m-0 box-border font-poppins min-w-[350px] min-h-[400px] bg-[#ffffff1a] bg-opacity-25 rounded-[10px] z-10 p-5'>
          ...
          {lists?.map((list) => {
            return (
              <Fragment key={list._id}>
                <div
                  className='mx-0 mb-0 mt-2.5 p=10 box-border font-poppins relative overflow-hidden p-2.5 gap-2.5 rounded-[10px] bg-[#0000001a] cursor-pointer transition-all duration-200 ease-linear hover:bg-zinc-100 hover:scale-[1.03] hover:translate-x-[6px] hover:translate-y-[-3px] group/list'
                >
                  <div onClick={() => navigate('/auth')} className='flex items-center'>
                  ...
                  <div className='m-0 p-0 box-border font-poppins text-white absolute bottom-0 -right-14 flex flex-col w-14 h-20 duration-200 group-hover/list:-right-0.5'>
                    <button
          ...
          <div className='mx-0 mb-0 mt-2.5 p=10 box-border font-poppins relative overflow-hidden flex items-center p-2.5 gap-2.5 rounded-[10px] bg-[#0000001a] cursor-pointer transition-all duration-200 ease-linear hover:bg-zinc-100 hover:scale-[1.03] hover:translate-x-[6px] hover:translate-y-[-3px] group/list'>
            ...
            <div className='m-0 px-0 pb-0 pt-2 box-border font-poppins text-white'>
              ...
              <h4 className='font-semibold leading-[1.2em] duration-200 group-hover/list:text-[#222]'>
                Item Title
              </h4>
              <p className='text-xs duration-200 group-hover/list:text-[#222]'>
                Item Description
              </p>
              <div className='absolute bottom-0 right-0 flex flex-col w-14 h-20'>
                <button
                  onClick={() => navigate('/ItemList')}
                  className='w-14 bg-blue-500 rounded-5 grow'
                >
