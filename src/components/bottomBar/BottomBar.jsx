          ...
          <AnimatePresence>
            {isComponentVisibleUser && (
              <motion.div
                id='userDropdown'
                // right-2---------------------\/
                className='absolute bottom-[4.5rem] bg-gradient-to-r from-purple-200 via-zinc-100 to-blue-200 divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600'
                ref={dropdownRefUser}
                initial={{
                  opacity: 0,
                  right: '-20rem',
