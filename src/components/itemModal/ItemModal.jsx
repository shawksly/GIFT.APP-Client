...
function ItemModal({ dropdownRefItem }) {
  return (
    <div ref={dropdownRefItem} className='relative'>
    <div className='fixed z-20 left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 flex justify-center items-center'>
      <div className='box-border w-30 h-80 font-poppins bg-gradient-to-br from-gray-500 via-blue-300 to-purple-20 justify-center items-center relative overflow-hidden border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700'>
        <h5 className='mb-4 mt-4 text-xl font-medium text-gray-200 dark:text-gray-400'>
          New Item
        </h5>
