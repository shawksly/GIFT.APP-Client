...
<div className="flex -space-x-4 rtl:space-x-reverse mr-4 pb-2">
    <img className="w-10 h-10 border-2 border-slate-700 rounded-full dark:border-gray-800 mr"  src='https://pixsector.com/cache/05d114c9/av16245af1936bbffccf4.png'  alt="" />
    <img className="w-10 h-10 border-2 border-purple-200  rounded-full dark:border-gray-800"  src='https://pixsector.com/cache/05d114c9/av16245af1936bbffccf4.png'  alt="" />
    <img className="w-10 h-10 border-2 border-purple-200  rounded-full dark:border-gray-800"  src='https://pixsector.com/cache/05d114c9/av16245af1936bbffccf4.png'  alt="" />
    <img className="w-10 h-10 border-2 border-purple-200  rounded-full dark:border-gray-800"  src='https://pixsector.com/cache/05d114c9/av16245af1936bbffccf4.png'  alt="" />
</div>
